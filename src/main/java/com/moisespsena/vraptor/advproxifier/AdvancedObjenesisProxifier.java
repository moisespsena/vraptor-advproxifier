 ...
 * 
 */
public class AdvancedObjenesisProxifier extends ObjenesisProxifier {
	@SuppressWarnings("rawtypes")
	@Override
	protected MethodInterceptor cglibMethodInterceptor(
			final MethodInvocation handler) {

		return new AdvancedMethodInterceptor<Object>() {
			@Override
			public Object getSharedObject() {
				final Object sharedObject = ((AdvancedMethodInvocation) handler)
						.getSharedObject();
				return sharedObject;
			}
